...
set CLASSPATH=%APP_HOME%\lib\lab02-1.0.jar;%APP_HOME%\lib\commons-csv-1.8.jar


@rem Execute lab02
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB02_OPTS%  -classpath "%CLASSPATH%" csci2020u.lab03.CSVDemo %*
